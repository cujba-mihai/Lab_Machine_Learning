...
# and data analysis tools, like DataFrame.
...
# It is used to create figures and plots.
...
# classes to change raw feature vectors into a representation that is more suitable for downstream estimators. It's used here for scaling.
...
# LinearRegression is a machine learning library for python that serves regression models. 

from sklearn import metrics 
# sklearn's metrics module implements functions assessing prediction error for specific purposes. 
# In this code, it's used for model evaluation.

from scipy import stats 
# scipy is a library used for scientific computing and technical computing. 
# scipy.stats contains a large number of probability distributions and statistical functions.

from mlxtend.evaluate import bias_variance_decomp 
# Mlxtend (machine learning extensions) is a Python library of useful tools for the day-to-day data science tasks. 
# The bias_variance_decomp method is used from this library for bias-variance decomposition.

import markdown 
# markdown is a Python library to convert markdown to HTML. It's a text-to-HTML conversion tool for web writers.

import time 
# time is a Python library for time-related tasks. It's used here to get the current time for naming the markdown file.
